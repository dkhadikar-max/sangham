  ...
  return (
    <header className="app-header">
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', flexShrink: 0 }}>
        ...
        {user && (
          <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-sangham-gold/30 cursor-pointer hover:border-sangham-gold transition-colors bg-sangham-cream flex items-center justify-center">
